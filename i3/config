...
# Games!
# bindsym $mod+k exec /home/dylan/KSP
...
bindsym $mod+Ctrl_R focus right
...
bindsym Ctrl+Mod1+Alt_R workspace prev
bindsym Ctrl+Mod1+Ctrl_R workspace next

# bindsym Shift+Mod1+Left move container to workspace prev
# bindsym Shift+Mod1+Right move container to workspace next

bindsym Ctrl+Mod1+Shift+Left exec --no-startup-id /home/$USER/bin/ws prev
bindsym Ctrl+Mod1+Shift+Right exec --no-startup-id /home/$USER/bin/ws next

bindsym Ctrl+Mod1+Shift+Alt_R move container to workspace prev
bindsym Ctrl+Mod1+Shift+Ctrl_R move container to workspace next
...
bindsym $mod+Shift+s exec --no-startup-id /home/$USER/bin/hdmi
...
bindsym Ctrl+$mod+l exec --no-startup-id  "/home/$USER/bin/i3lock-fancy -- scrot -z"
